                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="sidebar_description2" class="form-control" rows="6">{{$setting->sidebar_description2}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.title') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="typed_titlebig" class="form-control" value="{{$setting->typed_titlebig}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.subtitle') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="typed_subtitle" class="form-control" value="{{$setting->typed_subtitle}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>
                                                <input type="text" name="typed_desc" class="form-control" value="{{$setting->typed_desc}}">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="{{route('headerfooter-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>
                                                <textarea name="footer_col1_buttontext" class="form-control" rows="6">{{$setting->footer_col1_buttontext}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>
                                                <textarea name="footer_col1_buttonlink" class="form-control" rows="6">{{$setting->footer_col1_buttonlink}}</textarea>
                                            </div>
                                        </div>
                                    </div>
