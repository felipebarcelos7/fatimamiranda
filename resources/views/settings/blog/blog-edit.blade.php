                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="banner_btn_text" class="form-control" value="{{$setting->banner_btn_text}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <strong>{{clean( trans('niva-backend.button_link') , array('Attr.EnableID' => true))}}</strong>
                                                        <input type="text" name="banner_btn_link" class="form-control" value="{{$setting->banner_btn_link}}">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="html_sidebar1" class="form-control" rows="14">{{clean( $setting->html_sidebar1, array('Attr.EnableID' => true))}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.html_sidebar2') , array('Attr.EnableID' => true))}}</strong>
                                                <textarea name="html_sidebar2" class="form-control" rows="14">{{clean( $setting->html_sidebar2 , array('Attr.EnableID' => true))}}</textarea>
                                            </div>
                                        </div>
